...
My foxbox consists of a Raspberry Pi model B running pifox and is powered by a 6000mah usb power bank with a mausberrycircuits.com power switch and my gpio setup is laid out on an electro-resales gpio breakout pcb.  All this is fitted inside a 30 caliber ammo can by use of non conductive foam padding.  It starts transmitting automatically when the Pi is powered on and the transmit switch is flipped on.  The transmission of my call sign fox message and current time runs through gpio 4 and a lpf before reaching the antenna and also lighting an led indicating a transmission is in progress.  No handheld is needed the Pi is the radio transmitter.  You can also use audio out on the Pi to trigger vox on a handheld radio if your not comfortable building a low pass filter.  Led and switches are also optional as well as automatic or manual transmissions and timing.  Build your fox the way that suits you.  There are many customizable settings for pifox to fit your needs.  Please take a look at the schematics folder for pictures of my foxbox.
